...
data class ServicesVigilante(
        ...
        @SerialName("turno_id") val turno_id: Long,
        @SerialName("fecha_inicio_turno") val fecha_inicio_turno: Long,
        @SerialName("lat_ini") val lat_ini: Long,
        @SerialName("lon_ini") val lon_ini: Long,
